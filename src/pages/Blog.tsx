...
const Blog = () => {
  const blogPosts = [
    {
      slug: "colesterol-ldl-hdl-triglicerideos",
      title: "Colesterol Alto: O Guia Completo para Entender LDL, HDL e Triglicerídeos",
      excerpt: "Descubra a diferença entre colesterol ruim, bom e triglicerídeos e saiba como interpretar seus exames.",
      image: "/images/blog/exame-colesterol-triglicerideos-labclin.jpg",
      category: "Saúde do Coração",
      readTime: "6 min",
      publishDate: "12 Dez 2025",
      featured: true,
    },
    {
      slug: "tsh-t3-t4-tireoide",
      title: "TSH Alto ou Baixo? Entenda os Exames T3, T4 e TSH",
      excerpt: "Cansaço ou agitação? Entenda como o TSH regula sua tireoide e o que os exames dizem.",
      image: "/images/blog/exame-tireoide-tsh-t3-t4-labclin.jpg",
      category: "Tireoide",
      readTime: "5 min",
      publishDate: "12 Dez 2025",
    },
    {
      slug: "ureia-creatinina-rins",
      title: "Ureia e Creatinina: O que dizem sobre seus Rins?",
      excerpt: "Entenda os principais marcadores da função renal e previna doenças silenciosas.",
      image: "/images/blog/exame-creatinina-ureia-funcao-renal-labclin.jpg",
      category: "Saúde Renal",
      readTime: "5 min",
      publishDate: "12 Dez 2025",
    },
    {
      slug: "glicemia-jejum-hemoglobina-glicada-diferenca",
      title: "Glicemia de Jejum vs. Hemoglobina Glicada: Qual a Diferença?",
      excerpt: "Qual exame é mais confiável? Entenda a diferença entre a 'foto' do momento e o 'filme' dos últimos meses.",
    ...
    {
      slug: "labclin-precisao-qualidade",
      title: "Por Dentro do Labclin: Precisão e Qualidade que Você Pode Confiar",
      excerpt: "Como nossas certificações, equipamentos e equipe garantem a segurança do seu laudo.",
      image: "/images/faq/recepcao-laboratorio-rio-pomba.jpg",
